    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: `linear-gradient(135deg, ${style.palette[0]} 0%, ${style.palette[1]} 60%, ${style.palette[2]} 100%)`,
        }}
      >
        {/* Decorative SVG pot motif */}
        ...
        <div className="absolute top-3 left-3 flex gap-2 items-center">
          {style.gi && (
            <span
              ...
              style={{ background: 'rgba(13,8,4,0.55)', color: 'var(--c-gold)', border: '1px solid var(--c-gold)' }}
            >
              GI · TAG
            </span>
          )}
      ...
      <div className="p-6">
        ...
        <div
          className="italic mt-4 pt-4 border-t"
          style={{ borderColor: 'var(--line)', color: 'var(--c-gold)', fontSize: '0.92rem' }}
        >
          {style.quote}
        </div>
      </div>
      ...
      <span
        ...
        style={{ background: 'linear-gradient(90deg, var(--c-terracotta), var(--c-gold))' }}
      />
    </motion.article>
  )
}
